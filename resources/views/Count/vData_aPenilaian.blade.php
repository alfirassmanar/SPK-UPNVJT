                ...
                <div class="card-body">
                    ...
                    <nav class="d-none d-md-block" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Penilaian Kinerja Guru</li>
                        </ol>
                    </nav>
                    <!-- End Breadcrumb -->
                        ...
                        <form id="sawForm">
                            <div class="form-group">
                                ...
                                <select id="guruSelect" class="form-control">
                                    ...
                                    <!-- Tambahkan lebih banyak guru jika diperlukan -->
                                </select>
                                <button type="button" id="addGuru" class="btn btn-outline-success btn-sm mt-2">Tambah Guru</button>
                            </div>
                            ...
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody id="guruTableBody">
                                    <!-- Baris guru akan ditambahkan di sini -->
                                </tbody>
                            </table>
                    ...
                    <!-- End Form -->
                    <script>
                        document.getElementById("addGuru").addEventListener("click", function() {
                        var guruSelect = document.getElementById("guruSelect");
                        var guruName = guruSelect.value;

                        // Pastikan guru dipilih
                        if(guruName === "") {
                        ...
                        // Ambil body tabel
                        var tableBody = document.getElementById("guruTableBody");

                        // Buat baris baru untuk guru yang dipilih
                        var newRow = document.createElement("tr");

                        // Buat kolom nama guru
                        var nameCell = document.createElement("td");
                        nameCell.textContent = guruName;
                        newRow.appendChild(nameCell);

                        // Buat kolom input untuk setiap kriteria
                        var criteria = ["kbm", "ptpp", "kci", "pkpd", "kkpd", "knpd"];
                        criteria.forEach(function(criterion) {
                            var cell = document.createElement("td");
                            var input = document.createElement("input");
                            input.type = "number";
                            input.name = guruName.toLowerCase() + "_" + criterion;
                        ...
                        deleteButton.addEventListener("click", function() {
                            newRow.remove(); // Menghapus baris ketika tombol hapus diklik
                        });
                        ...
                        // Reset dropdown setelah menambahkan
                        guruSelect.value = "";
                    });
                    </script>
                </div>
