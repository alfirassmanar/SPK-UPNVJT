                ...
                <div class="card-body">
                    ...
                    <nav class="d-none d-md-block" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Penilaian Kriteria</li>
                        </ol>
                    </nav>
                    <!-- End Breadcrumb -->

                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <div class="h3 mb-0">Lembar Penilaian</div>
                    </div>
                        ...
                        <form>
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="" id="nip" name="nip" placeholder="2108xxx">
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <select class="form-control" id="namaGuru" name="namaGuru">
                                        ...
                                        @endforeach --}}
                                        <option value="1">Muhammad Gofar</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <label style="font-size: 10pt;"><i>(Kualitas kegiatan belajar dan mengajar)</i></label>
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <label style="font-size: 10pt;"><i>(Penguasaan teori dan prinsip pembelajaran)</i></label>
                                    <select class="form-control" id="k2" name="k2">
                                        <option value="">-- PTPP --</option>
                                        {{-- @foreach ($dataGuru as $guru)
                                            <option value="{{ $guru }}">{{ $guru }}</option>
                                        @endforeach --}}
                                        <option value="1">1</option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <label style="font-size: 10pt;"><i>(Kuantitas Izin dan Cuti)</i></label>
                                    <select class="form-control" id="k3" name="k3">
                                        <option value="">-- KCI --</option>
                                        {{-- @foreach ($dataGuru as $guru)
                                            <option value="{{ $guru }}">{{ $guru }}</option>
                                        @endforeach --}}
                                        <option value="1">1</option>
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <label style="font-size: 10pt;"><i>(Penguasaan karakteristik peserta didik)</i></label>
                                    <select class="form-control" id="k4" name="k4">
                                        <option value="">-- PKPD --</option>
                                        {{-- @foreach ($dataGuru as $guru)
                                            <option value="{{ $guru }}">{{ $guru }}</option>
                                        @endforeach --}}
                                        <option value="1">1</option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <label style="font-size: 10pt;"><i>(Kualitas komunikasi dengan peserta didik)</i></label>
                                    <select class="form-control" id="k5" name="k5">
                                        <option value="">-- KKPD --</option>
                                        {{-- @foreach ($dataGuru as $guru)
                                            <option value="{{ $guru }}">{{ $guru }}</option>
                                        @endforeach --}}
                                        <option value="1">1</option>
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <label for="k6">Kriteria 6</label>
                                    <label style="font-size: 10pt;"><i>(Kuantitas nilai peserta didik di bawah standar)</i></label>
                                    <select class="form-control" id="k6" name="k6">
                                        <option value="">-- KNPD --</option>
                                        {{-- @foreach ($dataGuru as $guru)
                                            <option value="{{ $guru }}">{{ $guru }}</option>
                                        @endforeach --}}
                                        <option value="1">1</option>
