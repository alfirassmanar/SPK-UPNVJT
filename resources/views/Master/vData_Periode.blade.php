    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="{{ asset('/temp/img/logo-mini.png') }}" alt="Graindashboard" style="width: auto; height: 33px;">
                <img class="side-nav-hide-on-closed" src="{{ asset('/temp/img/logo.png') }}" alt="Graindashboard" style="width: auto; height: 33px;">
            </a>
        ...
        <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
            ...
            <li class="side-nav-menu-item side-nav-has-menu">
                ...
                <ul id="subPages" class="side-nav-menu side-nav-menu-second-level mb-0">
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="login.html">Penilaian Kriteria</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="register.html">Bobot Kriteria</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="password-reset.html">Analisis Penilaian</a>
                    </li>
                </ul>
                <!-- End Pages: subPages -->
            </li>
            ...
            <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <div class="h3 mb-0">Tabel Data Periode</div>
                    </div>
