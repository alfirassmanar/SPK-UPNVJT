            ...
            <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <div class="h3 mb-0">Tabel Data Guru</div>
                    </div>

                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <a href="{{ route('tdataGuru') }}">
                    ...
                    <div class="table-responsive-xl">
                        <table class="table text-nowrap mb-0">
                            ...
                            <tr>
                                ...
                                <th class="font-weight-semi-bold border-top-0 py-2">Telpon</th>
                            ...
                            <tr>
                                ...
                                <td class="py-3">0823442027739</td>
                                <td class="py-3">Surabaya</td>
                                ...
                                <td class="py-3">
                                    <div class="position-relative">
                                        <a class="link-dark d-inline-block" href="{{ route('udataGuru') }}">
