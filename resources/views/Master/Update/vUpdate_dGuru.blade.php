                ...
                <div class="card-body">
                    ...
                    <nav class="d-none d-md-block" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Data Guru</li>
                        </ol>
                    </nav>
                    <!-- End Breadcrumb -->

                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <div class="h3 mb-0">Lembar Perubahan</div>
                    </div>
                        ...
                        <form>
                            <div class="form-row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="" id="namaGuru" name="namaGuru" placeholder="2108xxx">
                                </div>
                            </div>
                            
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <label for="nTelp">Telpon</label>
                                    <input type="text" class="form-control" value="" id="nTelp" name="nTelp" placeholder="0823xxxx">
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="alamat">Alamat</label>
                                    <input type="text" class="form-control" value="" id="alamat" name="alamat" placeholder="0823xxxx">
                                </div>
                            </div>

                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <label for="instansi_mengajar">Instansi Mengajar</label>
                                    <select class="form-control" id="instansi_mengajar" name="instansi_mengajar">
                                        <option value="">-- Pilih --</option>
                                        <option value="1">UPN Veteran Jawa Timur</option>                                 
                                    </select>
                                </div>
                                <div class="form-group col-12 col-md-6">
